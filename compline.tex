...
\renewcommand\gretranslationformat[1]{{\inglesh \fontsize{9}{7}\selectfont #1}}
...
\def\vern#1{{\inglesh \fontsize{9}{7}\selectfont #1}\par}
...
\rubrics{The cantors preintone the first line of the hymn which the velebrandt then intones aloud.  The celebrant's side sing the first verse, then the other side for the second verse then all together for the doxology.}
...
\begin{verse}
\inglesh \fontsize{9}{7} \selectfont
